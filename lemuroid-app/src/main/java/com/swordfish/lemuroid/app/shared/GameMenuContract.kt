...
object GameMenuContract {
    ...
    const val EXTRA_FAST_FORWARD_SPEED = "EXTRA_FAST_FORWARD_SPEED"
    const val EXTRA_SCREEN_FILTER = "EXTRA_SCREEN_FILTER"
    const val EXTRA_CURRENT_SAVE_SLOT = "EXTRA_CURRENT_SAVE_SLOT"
    ...
    const val RESULT_FAST_FORWARD_SPEED = "RESULT_FAST_FORWARD_SPEED"
    const val RESULT_SCREEN_FILTER = "RESULT_SCREEN_FILTER"
